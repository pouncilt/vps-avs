...
public class DateUtils {
  ...
  public static void main(String[] args) throws ParseException {
    String s = "DEC 01, 2014";
    Date dt = toDate(s, "MMM dd, yyyy");
    System.out.println(toAnsiDate(dt));
  }
  ...
  public static Date convertEnglishDatetimeStr(String englishDatetime) throws ParseException {
    ...
    public static Date convertShortEnglishDatetimeStr(String englishDatetime) throws ParseException {
        if (englishDatetime != null) {
            SimpleDateFormat dateFormatter = new SimpleDateFormat(ENGLISH_SHORT_DATE_TIME_FORMAT);
            return dateFormatter.parse(englishDatetime);
        }
        return null;
    }
