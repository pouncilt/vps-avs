...
public class LabChartsAction extends BaseAvsChartsAction {
  ...
  private static final String TPL_CHARTS_HTML = 
	...
	//System.out.println("inside LabChartsAction, charts method");
...
/*    System.out.println("super.patientDfn  = " + super.patientDfn);
    System.out.println("super.facilityNo  = " + super.facilityNo);
    ...
    StringBuffer body = new StringBuffer();
      ...
      while (it.hasNext()) {
        ...
        if ((chartData != null) && !chartData.isEmpty()) {
          ...
          if (chartAction != null) {
        	 // System.out.println("chartAction = " + chartAction);
...
/*      body.append("<script type=\"text/javascript\">\n");
      ...
      SortedSet<String> keys = new TreeSet<String>(charts.keySet());
      it = keys.iterator();
      while (it.hasNext()) {
        String chartId = it.next(); 
        body.append("<div id=\"" + chartId + "\" class=\"chart\"></div>");
      ...
      body.append("<script type=\"text/javascript\">\n");
      //keys = charts.keySet();
      keys = new TreeSet<String>(charts.keySet());
  ...
  public String bpChart() {
    ...
    while (it.hasNext()) {
      try {
       ...
       // System.out.println("sysVal = " + sysVal);
       // System.out.println("diaVal = " + diaVal);
...
/*	System.out.println("Inside doLineChart");
	System.out.println("chartType = " + chartType);
