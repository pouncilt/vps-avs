...
public class PatientAction extends BaseCardAction {
  ...
  public void prepare() throws Exception {
	...
	public String patientInfo() {
	  ...
	  patJson.setAge(AvsProps.IS_DEMO ? patientInfo.getAge() : AvsProps.DEMO_PT_AGE);
	  patJson.setDfn(patientInfo.getDfn());
	  patJson.setName(AvsProps.IS_DEMO ? patientInfo.getName() : AvsProps.DEMO_PT_NAME);
	  patJson.setSex(patientInfo.getSex());
	  patJson.setSsn(AvsProps.IS_DEMO ? patientInfo.getSsn() : AvsProps.DEMO_PT_SSN);
	  patJson.setDob(AvsProps.IS_DEMO ? patientInfo.getDobStr() : AvsProps.DEMO_PT_DOB);
	...
	public String patientEncounters() {
	  ...
	  ServiceResponse<FacilityPrefs> response = this.settingsService.getFacilityPrefs(super.securityContext, this.facilityNo);
