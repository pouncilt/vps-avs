...
public class EncounterNoteThread extends Thread {
      ...
      if (encounterInfo.getEncounterCache() != null) {      
        ...
        for (Encounter encounter : encounters) {
          if (encounter.getEncounterNoteIen() == null) {
            CollectionServiceResponse<String> csr = ddrVBService.execDdrLister(this.securityContext, "8925", null, ".01;.05;.07;1202;1211;.02", 
            ...
            for (String x : list) {
              ...
              if (encounter.getLocationIen().equals(locIen) && tempFmDtTm.equals(fmDtTm)) {
  ...
  private void saveEncounterNoteIens(EncounterCache encounterCache) {
    ...
    for (Encounter encounter : encounters) {
      ...
      encounter.setEncounterNoteIen(ien);
    }
