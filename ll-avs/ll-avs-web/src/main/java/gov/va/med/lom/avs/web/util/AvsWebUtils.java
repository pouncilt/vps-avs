...
public class AvsWebUtils {
  ...
  public static String savePdfToFile(String stationNo, String patientDfn, List<String> locationIens, 
    ...
    filename.append("-");
    filename.append(StringUtils.replaceChar(AvsUtils.delimitString(locationIens, false), ',', '_'));
    filename.append("-");
    filename.append(StringUtils.replaceChar(AvsUtils.delimitString(dtStr, false), '.', '-'));
    filename.append(".pdf");
