  ...
  public void prepare() throws Exception {
	...
	public String fetchSettings() {
	  ServiceResponse<FacilityPrefs> response = this.settingsService
        .getFacilityPrefs(super.securityContext, this.getDivisionNo());
...
/*     String hfStr = null;
    ...
    ServiceFactory.getSettingsService().saveFacilitySetting(super.securityContext, this.getDivisionNo(), this.setting, this.value);

	  return SUCCESS;
	}
	
  public String fetchTiuNoteText() {
    String text = this.settingsService.getTiuNoteTextForFacilty(super.securityContext, this.getDivisionNo()).getPayload();
  ...
  public String updateTiuNoteText() {
    ...
    ServiceFactory.getSettingsService().saveTiuNoteTextForFacility(super.securityContext, this.getDivisionNo(), this.tiuNoteText);
  ...
  public String fetchLabelsForGrid() {
    ...
    CollectionServiceResponse<StringResource> response = this.settingsService
        .getStringResources(super.securityContext, super.facilityNo, this.getLanguage());
  ...
  public String updateLabel() {
    ...
    StringResource stringResource = 
        ServiceFactory.getSettingsService().getStringResource(super.securityContext, super.facilityNo, this.name, this.getLanguage()).getPayload();
