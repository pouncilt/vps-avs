...
/*		System.out.println("Inside getLatestNumericValues");
		System.out.println("patientDfn = " + patientDfn);
		System.out.println("fileNum = " + fileNum);
		System.out.println("itemNum = " + itemNum);
		System.out.println("fmEndDate = " + fmEndDate);
		System.out.println("startMonthsAgo = " + startMonthsAgo);*/
		...
		//System.out.println("fmStartDate = " + fmStartDate);
		
		for (DiscreteItemData point : dataSet) {
			
/*			System.out.println("point.getFmDate() = " + point.getFmDate());
			System.out.println("point.getFmDate() = " + point.getFmDate());*/
