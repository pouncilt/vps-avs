...
public class EncounterCacheUpdate {
  ...
  public static void main(String[] args) throws IOException {
    ...
    try {
      jdbcConnection = new JdbcConnection(AvsProps.DB_URL, AvsProps.DB_DRIVER);
  ...
  private static RpcBroker getRpcBroker() throws Exception {
    ...
    if (rpcBroker.isConnected()) {
      ...
      System.err.println("Could not sign on to local RPC Broker server: " + AvsProps.VISTA_SERVER + ":" + AvsProps.VISTA_PORT);
    }
    return null;
  }  
