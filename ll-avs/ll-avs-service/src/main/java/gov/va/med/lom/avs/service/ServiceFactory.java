...
public class ServiceFactory {
  ...
  private static Context ctx;
	...
	public enum SERVICE {	  
      ...
      SETTINGS_REMOTE("ll-avs-1.3/gov.va.med.lom.avs.SettingsService/remote"),
  ...
  private static boolean isAlive(BaseService s) {
    ...
    public static SettingsService getRemoteSettingsService() {
        return (SettingsService)fetchService(SERVICE.SETTINGS_REMOTE, false);
    }
