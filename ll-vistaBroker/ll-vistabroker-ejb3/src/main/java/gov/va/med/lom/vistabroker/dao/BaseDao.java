...
public class BaseDao {
  ...
  static {
	...
	public BaseDao(BaseDao baseDao) {
		...
		/*
		System.out.println("VP: Inside public BaseDao(BaseDao baseDao) defaultContext = " + defaultContext);
		System.out.println("VP: Inside public BaseDao(BaseDao baseDao) defaultRpcName = " + defaultRpcName);
		System.out.println("VP: Inside public BaseDao(BaseDao baseDao) rpcName = " + rpcName);
		
		System.out.println("VP: Inside BaseDao(BaseDao baseDao) securityContext.getDivision() = " + securityContext.getDivision());
		System.out.println("VP: Inside BaseDao(BaseDao baseDao) securityContext.getUserId() = " + securityContext.getUserId());
		*/
    ...
    protected String sCall(List<? extends Object> params) throws VistaBrokerException {
        try {
            RpcRequest req = null;
	...
	protected String sCall(RpcRequest req) throws VistaBrokerException {
		...
		//System.out.println("VP: Inside sCall(RpcRequest req) securityContext.getDivision() = " + securityContext.getDivision());
		//System.out.println("VP: Inside sCall(RpcRequest req) securityContext.getUserId() = " + securityContext.getUserId());
			...
			if (conn == null) {
				...
				case ISecurityContext.VPID_CONNECTION_SPEC : 
					connSpec = new VistaLinkVpidConnectionSpec(securityContext.getDivision(), securityContext.getUserId());
					  //System.out.println("VP: VPID_CONNECTION_SPEC: securityContext.getDivision() = " + securityContext.getDivision());
					  //System.out.println("VP: VPID_CONNECTION_SPEC: securityContext.getUserId() = " + securityContext.getUserId());
					break;
				case ISecurityContext.APP_PROXY_CONNECTION_SPEC : 
					...
					//System.out.println("VP: APP_PROXY_CONNECTION_SPEC: securityContext.getDivision() = " + securityContext.getDivision());
					//System.out.println("VP: APP_PROXY_CONNECTION_SPEC: securityContext.getUserId() = " + securityContext.getUserId());
					break;
				...
				case ISecurityContext.CCOW_HOST_CONNECTION_SPEC : 
					...
					//System.out.println("VP: CCOW_HOST_CONNECTION_SPEC: securityContext.getDivision() = " + securityContext.getDivision());
					//System.out.println("VP: CCOW_HOST_CONNECTION_SPEC: securityContext.getUserId() = " + securityContext.getUserId());
					break;
				case ISecurityContext.DUZ_CONNECTION_SPEC : 
					...
					//System.out.println("VP: DUZ_CONNECTION_SPEC: securityContext.getDivision() = " + securityContext.getDivision());
					//System.out.println("VP: DUZ_CONNECTION_SPEC: securityContext.getUserId() = " + securityContext.getUserId());
					break;            
				}
				if (connSpec != null) {
				  try {
					  
					 // System.out.println("VP: securityContext.getDivision() = " + securityContext.getDivision());
					  //System.out.println("VP: securityContext.getUserId() = " + securityContext.getUserId());
    ...
    protected List<String> lCall(List<? extends Object> params) throws VistaBrokerException {
        return StringUtils.getStringList(sCall(params));
    }
