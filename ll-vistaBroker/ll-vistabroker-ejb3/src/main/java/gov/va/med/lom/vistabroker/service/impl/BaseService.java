...
public class BaseService implements Service {
    ...
    protected Object invokeCall(Class daoClass, String methodName, Object[] args)
        ...
        try {
            ...
            if (securityContext.getRpcName() != null && securityContext.getRpcName().trim().length() > 0) {
    ...
    protected <T> CollectionServiceResponse<T> collectionResult(Class T, Class daoClass, String methodName, Object[] args) {
        ...
        try {
            ...
            Collection<T> result = (Collection<T>) invokeCall(daoClass, methodName, args);
            ...
            if (cause instanceof VistaBrokerException) {
                if (cause instanceof VistaBrokerSocketTimeoutException) {
                    // add the timeout as a property
                    String[] properties = {String.valueOf(((VistaBrokerSocketTimeoutException) cause).getTimeout())};
