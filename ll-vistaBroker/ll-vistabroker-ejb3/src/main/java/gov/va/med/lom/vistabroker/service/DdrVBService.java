...
public interface DdrVBService extends Service {
  ...
  public abstract CollectionServiceResponse<String> execDdrGetsEntry(ISecurityContext securityContext, DdrParams ddrParams);
  public abstract CollectionServiceResponse<String> execDdrLister(ISecurityContext securityContext, DdrParams ddrParams);
  public abstract ServiceResponse<String> execDdrValidator(ISecurityContext securityContext, DdrParams ddrParams);
  public abstract CollectionServiceResponse<String> execIenNameQuery(ISecurityContext securityContext, String fileNumber);
  public abstract CollectionServiceResponse<String> execFileQuery(ISecurityContext securityContext, String fileNumber, String fieldString); 
