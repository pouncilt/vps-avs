...
public interface PatientVBService extends Service {
  ...
  public abstract CollectionServiceResponse<String> sendOrders(ISecurityContext securityContext, String patientDfn, String providerDuz, 
 ...
 // public abstract ServiceResponse<String> savePceData(ISecurityContext securityContext, List<String> pceList, String noteIen, String locationIen);
  ...
  public abstract ServiceResponse<String> getDfltPtList(ISecurityContext securityContext);
  ...
  public abstract CollectionServiceResponse<VistaImageInfo> retrieveVistaImageDescriptions(ISecurityContext securityContext, List<Object> params);
  public abstract CollectionServiceResponse<VistaImageQueueInfo> retrieveVistaImages(ISecurityContext securityContext, List<String> params);
