...
public class PatientVBServiceImpl extends BaseService implements PatientVBService,
  ...
  public CollectionServiceResponse<String> sendOrders(ISecurityContext securityContext, String patientDfn, String providerDuz, 
      String encLocation, String esCode, List<String> orderList) throws Exception {
    setSecurityContext(securityContext);
    Object[] params = { patientDfn, providerDuz, encLocation, esCode, orderList };
    return collectionResult(String.class, OrdersDao.class, "sendOrders", params);     
  }
...
/*  public ServiceResponse<String> savePceData(ISecurityContext securityContext, 
  ...
  public ServiceResponse<String> getDfltPtList(
      ISecurityContext securityContext) {
    setSecurityContext(securityContext);
    return singleResult(String.class, PatientSelectionDao.class,
        "getDfltPtList");
  ...
  public CollectionServiceResponse<String> importVistaImage(ISecurityContext securityContext, List<String> nodeList) {
    ...
    @Override
    public CollectionServiceResponse<VistaImageInfo> retrieveVistaImageDescriptions(ISecurityContext securityContext,List<Object> params) {
        setSecurityContext(securityContext);
        return collectionResult(String.class, VistaImagingDao.class, "retrieveVistaImageDescriptions", params);
    }

    @Override
    public CollectionServiceResponse<VistaImageQueueInfo> retrieveVistaImages(ISecurityContext securityContext, List<String> params) {
        setSecurityContext(securityContext);
        return collectionResult(String.class, VistaImagingDao.class, "retrieveVistaImages", params);
    }
